...
本文介绍如何在单一的服务器上安装kubernetes1.12.8
...
给镜像打标签
# docker tag mirrorgooglecontainers/kube-apiserver:v1.12.7 k8s.gcr.io/kube-apiserver:v1.12.8
# docker tag mirrorgooglecontainers/kube-controller-manager:v1.12.7 k8s.gcr.io/kube-controller-manager:v1.12.8
# docker tag mirrorgooglecontainers/kube-scheduler:v1.12.7 k8s.gcr.io/kube-scheduler:v1.12.8
# docker tag mirrorgooglecontainers/kube-proxy:v1.12.7 k8s.gcr.io/kube-proxy:v1.12.8
...
3.2 安装
```
# kubeadm init --kubernetes-version=v1.12.8 --pod-network-cidr=10.244.0.0/16
```
