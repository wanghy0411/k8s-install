本文介绍如何如何部署一个kubernetes1.12.10的高可用集群
说明: 
...
虚拟ip:
192.168.234.110 此IP为集群虚拟出来的IP，用于k8s集群高可用。
192.168.234.100 此IP为traefik对应的负载均衡虚拟IP，集群外部实际访问的是这个地址
```
...
删除临时镜像
# docker rmi mirrorgooglecontainers/kube-apiserver:v1.12.10
# docker rmi mirrorgooglecontainers/kube-proxy:v1.12.10
# docker rmi mirrorgooglecontainers/kube-controller-manager:v1.12.10
# docker rmi mirrorgooglecontainers/kube-scheduler:v1.12.10
